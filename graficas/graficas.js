...
/*Municipios*/
function estado_Municipio(idEstado,listaStr){
	var labelss=listaStr.split(1);
	labelss.splice(-1,1);
	console.log(labelss)
...
function GraficaEnfermedades(enfermedad,datos){
	let graficaPorEstado= document.getElementById("enfermedad").getContext("2d");
	var labelss=datos.split(1);
